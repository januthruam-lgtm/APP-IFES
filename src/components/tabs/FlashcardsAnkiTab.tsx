  ...
  return (
    <div className="p-4 sm:p-8 max-w-4xl mx-auto space-y-6 animate-in fade-in">
      ...
      <div className="p-6 rounded-3xl bg-[var(--app-card)] border border-[var(--app-border)] shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="px-4 py-2 rounded-2xl bg-[var(--app-card-secondary)] border border-[var(--app-border)] text-xs font-bold text-emerald-600 dark:text-emerald-400 flex items-center gap-2 self-start sm:self-auto">
      ...
      {currentCard && (
        <div className="space-y-4">
          <div
            ...
            className="min-h-[260px] sm:min-h-[300px] p-8 rounded-3xl bg-[var(--app-card)] border border-[var(--app-border)] shadow-md flex flex-col justify-between cursor-pointer hover:border-[var(--app-primary)]/50 transition-all select-none group relative overflow-hidden"
          >
            <div className="flex items-center justify-between text-xs text-[var(--app-text-muted)]">
              ...
              <span className="flex items-center gap-1 text-[var(--app-primary)] font-semibold group-hover:underline">
            ...
            <div className="my-auto text-center py-4 space-y-2">
              <span className="text-xs uppercase font-extrabold tracking-widest text-[var(--app-primary)] block">
                {isFlipped ? "RESPOSTA" : "PERGUNTA"}
              </span>
              <h3 className="text-lg sm:text-xl font-bold text-[var(--app-text)] leading-relaxed max-w-xl mx-auto">
                {isFlipped ? currentCard.answer : currentCard.question}
              </h3>
            </div>

            <div className="text-center text-[11px] text-[var(--app-text-muted)]">
          ...
          {isFlipped ? (
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 animate-in fade-in">
              <button
                ...
                className="p-3 rounded-2xl bg-rose-500/20 hover:bg-rose-500/30 text-rose-600 dark:text-rose-400 border border-rose-500/30 text-xs font-bold transition flex flex-col items-center gap-1 cursor-pointer"
              >
                <span>Errei</span>
              ...
              <button
                ...
                className="p-3 rounded-2xl bg-amber-500/20 hover:bg-amber-500/30 text-amber-600 dark:text-amber-400 border border-amber-500/30 text-xs font-bold transition flex flex-col items-center gap-1 cursor-pointer"
              >
                <span>Difícil</span>
              ...
              <button
                ...
                className="p-3 rounded-2xl bg-[var(--app-primary)]/15 hover:bg-[var(--app-primary)]/25 text-[var(--app-primary)] border border-[var(--app-primary)]/30 text-xs font-bold transition flex flex-col items-center gap-1 cursor-pointer"
              >
                <span>Bom</span>
              ...
              <button
                ...
                className="p-3 rounded-2xl bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 text-xs font-bold transition flex flex-col items-center gap-1 cursor-pointer"
              >
                <span>Fácil</span>
            ...
            <button
              ...
              className="w-full py-3.5 rounded-2xl bg-[var(--app-primary)] hover:bg-[var(--app-primary-hover)] text-white font-bold text-xs flex items-center justify-center gap-2 shadow-xs transition cursor-pointer"
            >
